...
namespace WasmStore.Server.Migrations
{
    ...
    [Migration("20230923122134_InitialCreate")]
            ...
            modelBuilder.Entity("WasmStore.Server.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d52f42b7-42fa-429f-b2fd-ecf4a41716fd"),
                            DateCreated = new DateTime(2023, 9, 23, 12, 21, 34, 287, DateTimeKind.Utc).AddTicks(3091),
                        ...
                        new
                        {
                            Id = new Guid("30c62d9c-d226-49ed-849e-bfb2207fb607"),
                            DateCreated = new DateTime(2023, 9, 23, 12, 21, 34, 287, DateTimeKind.Utc).AddTicks(3115),
                            DateModified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("WasmStore.Server.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3a667b4e-965b-4921-bc1b-0bae6a1a1d68"),
                            CategoryId = new Guid("d52f42b7-42fa-429f-b2fd-ecf4a41716fd"),
                            DateCreated = new DateTime(2023, 9, 23, 12, 21, 34, 287, DateTimeKind.Utc).AddTicks(3270),
                            DateModified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("fc802c83-f1d4-4f2a-a35a-c70a06e46937"),
                            CategoryId = new Guid("d52f42b7-42fa-429f-b2fd-ecf4a41716fd"),
                            DateCreated = new DateTime(2023, 9, 23, 12, 21, 34, 287, DateTimeKind.Utc).AddTicks(3281),
                            DateModified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("7be915a5-ff25-4bb9-aa01-23606f85ebce"),
                            CategoryId = new Guid("30c62d9c-d226-49ed-849e-bfb2207fb607"),
                            DateCreated = new DateTime(2023, 9, 23, 12, 21, 34, 287, DateTimeKind.Utc).AddTicks(3284),
                            DateModified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
